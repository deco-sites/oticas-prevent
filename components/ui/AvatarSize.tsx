...
const colors: Record<string, string> = {
    ...
    "disabled": "line-through text-neutral-content ring-1 ring-slate-400 rounded-full",
  ...
  function AvatarSize({ link, content, variant = "default" }: Props) {
    return (
        <a href={link} rel="nofollow" class={content == "pequeno" ? "order-1" : content == "medio" ? "order-2" : content == "grande" ? "order-3" : "order-4"}>
