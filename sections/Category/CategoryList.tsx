...
function CategoryList(props: Props) {
  ...
  return (
    ...
    >
      ...
      <Slider class="carousel carousel-start grid-cols-2 md:grid md:grid-cols-5 gap-4 lg:gap-8 row-start-2 row-end-5">
        {list.map((
          ...
          >
            <a
              href={href}
              class="flex flex-col gap-4 md:w-full w-40 lg:h-auto"
            >
